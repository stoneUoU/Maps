...
//    let height = UIScreen.main.bounds.height
    ...
    open func initView(categories: [String]) {
        ...
        self.categoryLabel.text = "推荐"
        self.categoryLabel.font = UIFont.systemFont(ofSize: 13)
        self.categoryLabel.textColor = UIColor.darkGray
        self.addSubview(self.categoryLabel)
        
        let font = UIFont.systemFont(ofSize: 12)
        let userAttributes = [NSForegroundColorAttributeName:UIColor.gray,NSFontAttributeName:font];
        ...
        self.searchHistoryLabel.text = "搜索记录"
    ...
    open func redrawSearchHistoryButtons() {
        ...
        self.clearHistoryButton.setTitle("清空搜索记录", for: .normal)
