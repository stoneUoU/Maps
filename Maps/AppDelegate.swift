...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var noticeObser:Bool? {
        didSet {
            _ = SnailNotice.add(observer: self, selector: #selector(AppDelegate.loadHomeViewCtrl), notification: .startFinish)
        }
    }
    ...
    fileprivate func createKeyWindow() {
        ...
        if keychain.getBool("ifY") as? Bool == nil{
...
//        let navgationController = UINavigationController(rootViewController: SmsLoginViewCtrl());
//        window?.rootViewController = navgationController
        //已登录走这
        //window?.rootViewController = AppStartVC()
        window?.rootViewController = CustomTabBarVC()
//        let loginV = UINavigationController(rootViewController: LoginVC());
//        window?.rootViewController = loginV
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Centers")
